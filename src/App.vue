...
export default {
  data() {
    return {
      ...
      defaultPlaceUrl:
        'https://ptx.transportdata.tw/MOTC/v2/Tourism/ScenicSpot/Taipei?$top=1&$format=JSON',
      defaultFoodUrl:
        'https://ptx.transportdata.tw/MOTC/v2/Tourism/Restaurant/Taipei?$top=1&$format=JSON',
      defaultEventUrl:
        'https://ptx.transportdata.tw/MOTC/v2/Tourism/Activity/Taipei?$top=1&$format=JSON',
      // Data 存放
      cityData: [
  ...
  computed: {
    placeUrl() {
      ...
      return `https://ptx.transportdata.tw/MOTC/v2/Tourism/${this.filteredTypeData}/${this.filteredData}?$top=6&$format=JSON`;
    },
    foodUrl() {
